...
void setup() { 
  ...
  myservo1.write(0,255,true); // set the intial position of the servo, as fast as possible, wait until done
} 

void loop() {
  myservo.write(180,255,true);        // move the servo to 180, max speed, wait until done
  myservo1.write(180,255,true);        // move the servo to 180, max speed, wait until done
  ...
  myservo1.write(0,30,true);           // move the servo to 180, slow speed, wait until done
} 
